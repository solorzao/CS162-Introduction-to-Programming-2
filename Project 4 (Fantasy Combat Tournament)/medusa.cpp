...
Medusa::Medusa(std::string n)   //constructor that initializes attribute values unique to class
{
	name = n;
	type = "Medusa";
	armor_pts = 3;
...
void Medusa::recovery()	//restore half of damage taken
{
	total_damage_taken = 8 - strength_pts;
