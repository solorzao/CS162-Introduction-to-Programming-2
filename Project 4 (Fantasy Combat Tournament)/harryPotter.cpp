...
HarryPotter::HarryPotter(std::string n)  //constructor that initializes attribute values unique to class
{
	name = n;
	type = "Harry Potter";
	armor_pts = 0;
...
void HarryPotter::recovery()	//restore half of damage taken
{
	total_damage_taken = 10 - strength_pts;
